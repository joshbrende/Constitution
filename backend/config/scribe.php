...
return [
    ...
    'title' => 'ZANUPF Constitution & Academy API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'JSON API for the ZANUPF mobile app and integrations (constitution reader, academy, dialogue, profile).',
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                // Laravel default health route (we document GET /api/v1/health instead)
            ],
        ],
    ],
    ...
    'try_it_out' => [
        ...
        'enabled' => env('SCRIBE_TRY_IT_OUT', true),
    ...
    'postman' => [
        ...
        'overrides' => [
            'info.name' => 'ZANUPF Constitution & Academy API',
            'info.description' => 'Mobile and integration API for ZANUPF Constitution & Academy platform.',
        ],
    ],
    ...
    'openapi' => [
        ...
        'overrides' => [
            'info.title' => 'ZANUPF Constitution & Academy API',
            'info.version' => '1.0.0',
        ],
