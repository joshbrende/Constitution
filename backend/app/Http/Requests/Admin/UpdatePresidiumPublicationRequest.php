...
class UpdatePresidiumPublicationRequest extends FormRequest
{
    ...
    {
        /** @var PresidiumPublication|null $publication */
        ...
        return [
            'slug' => [
                ...
                'string',
                'max:255',
                'unique:presidium_publications,slug,'.($publication?->id ?? 'NULL'),
            ],
