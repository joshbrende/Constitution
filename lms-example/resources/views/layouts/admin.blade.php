                ...
                <nav class="card shadow-sm admin-sidebar">
                    <div class="card-body py-2">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('help.admin') ? 'active' : '' }}" href="{{ route('help.admin') }}">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('courses.instructor') || request()->routeIs('courses.attendance') ? 'active' : '' }}" href="{{ route('courses.instructor') }}">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('admin.certificate-signatures*') ? 'active' : '' }}" href="{{ route('admin.certificate-signatures.index') }}">
                                    <i class="bi bi-pen me-2"></i>Certificate signatures
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('admin.certificate-templates*') ? 'active' : '' }}" href="{{ route('admin.certificate-templates.index') }}">
                                    <i class="bi bi-file-earmark-pdf me-2"></i>Certificate templates
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('courses.attendance') ? 'active' : '' }}" href="{{ route('admin.dashboard') }}#attendance">
