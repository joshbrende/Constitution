...
<aside class="learn-sidebar" id="learn-sidebar">
    ...
    <nav class="py-2">
        ...
        <div class="learn-day" data-day="<?php echo e($d); ?>">
            ...
            ?>
            <?php if($locked): ?>
            <div class="learn-nav-item learn-nav-item-locked" title="Pass the previous module's quiz to unlock">
...
<div class="learn-content-wrap">
    ...
    <div class="alert alert-warning"><i class="bi bi-lock me-2"></i>This module is locked. Pass the previous module's quiz to unlock it.</div>
    ...
    <div class="alert <?php echo e($passed ? 'alert-success' : 'alert-warning'); ?> mb-4">
        ...
        <?php echo e($passed ? 'Quiz passed!' : 'Quiz not passed.'); ?> You scored <?php echo e($attempt->score); ?>/<?php echo e($attempt->total_points); ?> (<?php echo e(number_format($attempt->percentage, 1)); ?>%).
        <?php if($nextUnit && !$nextLocked && $passed): ?> The next module is unlocked. <?php elseif($passed && !$nextUnit): ?> This was the final quiz—you've completed the course! <?php endif; ?>
    </div>
    ...
    <div class="alert alert-success"><i class="bi bi-check-circle me-2"></i>You have passed this quiz. <?php if($nextUnit && !$nextLocked): ?> The next module is unlocked. <?php else: ?> This was the final quiz—you've completed the course! <?php endif; ?></div>
    <?php if($nextUnit && !$nextLocked): ?>
    ...
    <div class="learn-body mb-4">
        ...
        <p class="text-muted small mt-2">Pass mark: <?php echo e($quiz->pass_percentage); ?>%. You may retake the quiz if you do not pass.</p>
    </div>
    <form action="<?php echo e(route('learn.quiz.submit', [$course, $current])); ?>" method="post" class="learn-quiz-form">
        ...
        <button type="submit" class="btn btn-danger learn-btn-complete"><i class="bi bi-send me-1"></i> Submit quiz</button>
    </form>
    <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if(!$currentDone): ?>
    <form action="<?php echo e(route('learn.unit.complete', [$course, $current])); ?>" method="post" class="mt-4">
        <?php echo csrf_field(); ?>
        <button type="submit" class="learn-btn-complete"><i class="bi bi-check-lg me-1"></i> Mark complete</button>
    </form>
    <?php elseif(empty($courseFinished)): ?>
    <p class="text-muted mt-4 mb-0"><i class="bi bi-check-circle me-1"></i> This lesson is complete. Use the navigation below or the sidebar to continue.</p>
    <?php endif; ?>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>
...
<div class="learn-bottom-bar">
    ...
    <span class="text-muted" title="Pass the current module's quiz to unlock">Next: <?php echo e($nextUnit->title); ?> <i class="bi bi-lock"></i></span>
    <?php else: ?>
...
<?php echo $__env->make('layouts.learn', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\Training\lms\resources\views/courses/learn.blade.php ENDPATH**/ ?>