...
?>
<div id="facilitator-chat-wrap" class="facilitator-chat-wrap" data-index-url="<?php echo e($indexUrl); ?>" data-store-url="<?php echo e($storeUrl); ?>" data-update-url-base="<?php echo e($updateUrlBase); ?>" data-unit-id="<?php echo e($unitId or ''); ?>" data-is-facilitator="<?php echo e($isFacilitator ? '1' : '0'); ?>" data-instructor-url="<?php echo e($instructorPageUrl ?? ''); ?>">
  ...
  <aside class="facilitator-chat-panel" id="facilitator-chat-panel" aria-label="Chat with facilitator">
    <div class="facilitator-chat-header">
      ...
      <?php if($instructorPageUrl): ?>
      <a href="<?php echo e($instructorPageUrl); ?>" target="_blank" rel="noopener" class="btn btn-link btn-sm text-dark">Open in new window</a>
      <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\wamp64\www\Training_1\lms\resources\views/courses/_facilitator_chat_panel.blade.php ENDPATH**/ ?>