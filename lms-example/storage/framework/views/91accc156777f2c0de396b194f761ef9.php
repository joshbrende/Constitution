...
<body class="d-flex flex-column">
    <header class="learn-topbar d-flex align-items-center px-3">
        ...
        <a href="<?php echo e(route('notifications.index')); ?>" class="text-light text-decoration-none small ms-auto me-2" title="Notifications"><i class="bi bi-bell"></i><?php if(($unreadN = auth()->user()->unreadNotifications()->count()) > 0): ?><span class="badge bg-danger rounded-pill ms-1"><?php echo e($unreadN > 9 ? '9+' : $unreadN); ?></span><?php endif; ?></a>
        <a href="<?php echo e(route('profile.edit')); ?>" class="text-light-50 text-decoration-none small me-2"><?php echo e(auth()->user()->name); ?></a>
        <a href="<?php echo e(route('courses.my')); ?>" class="text-light ms-0 small">Exit to my courses</a>
        <?php endif; ?>
    </header>
...
<?php /**PATH C:\wamp64\www\Training_2\lms\resources\views/layouts/learn.blade.php ENDPATH**/ ?>