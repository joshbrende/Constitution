    ...
    <div class="card-body p-0">
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item d-flex align-items-center justify-content-between">
                <span><i class="bi bi-file-text text-muted me-2"></i><?php echo e($item['title']); ?></span>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\Training\lms\resources\views/courses/_curriculum_edit.blade.php ENDPATH**/ ?>